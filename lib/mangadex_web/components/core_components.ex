defmodule MangadexWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MangadexWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MangadexWeb.Gettext, "errors", msg, opts)
    end
  end
